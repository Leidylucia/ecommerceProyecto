                                        ...
                                        <ul class="list-unstyled">
                                            @if (!isset($productos_categoriasid))
                                                @foreach (\App\Category::get() as $category)
                                                    <li class="mb-2 ml-2">
                                                        <a class="text-reset fs-14" href="{{ route('products.category', $category->productos_categoriasid) }}">{{ $category->descripcion }}</a>
                                                    </li>
                                                @endforeach
                                            @else
                                                <li class="mb-2">
                                                ...
                                                <li class="mb-2">
                                                    <a class="text-reset fs-14 fw-600" href="{{ route('products.category', \App\Category::where('productos_categoriasid',$productos_categoriasid)->first()->productos_categoriasid) }}">
                                                        <i class="las la-angle-left"></i>
                        ...
                        <ul class="breadcrumb bg-transparent p-0">
                            ...
                            @if(!isset($productos_categoriasid))
                                <li class="breadcrumb-item fw-600  text-dark">
                                    <a class="text-reset" href="{{ route('search') }}">"Todas las categorías"</a>
                                </li>
                            @else
                                <li class="breadcrumb-item opacity-50">
                                    <a class="text-reset" href="{{ route('search') }}">Todas las categorías</a>
                            ...
                            @if(isset($productos_categoriasid))
                                <li class="text-dark fw-600 breadcrumb-item">
                                    <a class="text-reset" href=""> "{{  \App\Category::where('productos_categoriasid',$productos_categoriasid)->first()->descripcion }}"</a>
                                </li>
                            @endif
