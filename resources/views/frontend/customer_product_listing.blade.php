                            ...
                            <div class="d-flex">
                                <div class="form-group w-200px">
                                    ...
                                    <select class="form-control form-control-sm aiz-selectpicker" name="sort_by" onchange="filter()">
                                        <option value="1" @isset($sort_by) @if ($sort_by == '1') selected @endif @endisset>Lo mas nuevo</option>
                                        <option value="2" @isset($sort_by) @if ($sort_by == '2') selected @endif @endisset>Lo mas viejo</option>
                                        <option value="3" @isset($sort_by) @if ($sort_by == '3') selected @endif @endisset>Precios de barato a caro</option>
                                        <option value="4" @isset($sort_by) @if ($sort_by == '4') selected @endif @endisset>Precios de caro a barato</option>
                                    </select>
                                </div>
                                <div class="form-group ml-auto mr-0 w-200px d-none d-md-block">
                                    ...
                                    <select class="form-control form-control-sm aiz-selectpicker" name="condition" onchange="filter()">
                                        ...
                                        <option value="new" @isset($condition) @if ($condition == 'new') selected @endif @endisset>Nuevo</option>
                                        <option value="used" @isset($condition) @if ($condition == 'used') selected @endif @endisset>Usado</option>
                                    </select>
                                </div>
